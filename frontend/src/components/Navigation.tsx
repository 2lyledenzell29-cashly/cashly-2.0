...
const Navigation: React.FC<NavigationProps> = ({ currentPage }) => {
  ...
  const navItems = [
    ...
    { 
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM4.828 4.828A4 4 0 015.5 4H9v1H5.5a3 3 0 00-2.121.879l-.707.707A1 1 0 002 7.414V16a2 2 0 002 2h8a2 2 0 002-2v-5a1 1 0 00-.293-.707l-8-8z" />
        </svg>
      )
    },
  ];
  ...
  return (
    <>
      ...
      {/* Top bar for mobile */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-10 bg-white shadow-sm border-b border-gray-200">
