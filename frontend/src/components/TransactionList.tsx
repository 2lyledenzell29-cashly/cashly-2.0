              ...
              <div className="sm:hidden">
                ...
                <div className="mb-3">
                  <div className="flex flex-wrap gap-2 text-xs text-gray-500">
                    <span className="bg-gray-100 px-2 py-1 rounded">{getCategoryName(transaction.category_id)}</span>
                    <span className="bg-gray-100 px-2 py-1 rounded">{getWalletName(transaction.wallet_id)}</span>
                    <span className="bg-gray-100 px-2 py-1 rounded">{new Date(transaction.created_at).toLocaleDateString()}</span>
                  </div>
                </div>
                ...
                <div className="flex justify-end space-x-3">
                  <button
                    ...
                    disabled={loading}
                    className="flex items-center justify-center w-10 h-10 text-gray-400 hover:text-gray-600 disabled:opacity-50 bg-gray-50 rounded-lg"
                  >
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="flex items-center justify-center w-10 h-10 text-gray-400 hover:text-red-600 disabled:opacity-50 bg-gray-50 rounded-lg"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-3 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 px-4 py-3">
                <button
                  ...
                  disabled={loading}
                  className="flex-1 px-4 py-3 bg-red-500 text-white text-base font-medium rounded-lg hover:bg-red-600 disabled:opacity-50"
                >
                  {loading ? '...' : 'Delete'}
                </button>
                <button
                  onClick={() => setDeleteConfirm(null)}
                  className="flex-1 px-4 py-3 bg-gray-500 text-white text-base font-medium rounded-lg hover:bg-gray-600"
                >
                  Cancel
                </button>
              </div>
